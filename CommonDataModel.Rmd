...
```{r cdmDiagram, fig.cap="Aperçu de toutes les tables dans le CDM version 6.0. Notez que toutes les relations entre les tables ne sont pas montrées.",echo=FALSE, out.width="100%"}
